...
/* Dependencies */
typedef enum ProtocolIE_Field_128P0__value_PR {
	ProtocolIE_Field_128P0__value_PR_NOTHING,	/* No components present */
	
} ProtocolIE_Field_128P0__value_PR;

/* ProtocolIE-Field */
typedef struct ProtocolIE_Field_128P0 {
	ProtocolIE_ID_t	 id;
	Criticality_t	 criticality;
	struct ProtocolIE_Field_128P0__value {
		ProtocolIE_Field_128P0__value_PR present;
