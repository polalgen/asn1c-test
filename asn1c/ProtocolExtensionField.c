...
static const asn_ioc_cell_t asn_IOS_AllocationAndRetentionPriority_ExtIEs_1_rows[] = {
	
};
static const asn_ioc_set_t asn_IOS_AllocationAndRetentionPriority_ExtIEs_1[] = {
	0, 0, asn_IOS_AllocationAndRetentionPriority_ExtIEs_1_rows
};
static int
...
static asn_CHOICE_specifics_t asn_SPC_extensionValue_specs_4 = {
	sizeof(struct ProtocolExtensionField_176P0__extensionValue),
	offsetof(struct ProtocolExtensionField_176P0__extensionValue, _asn_ctx),
	offsetof(struct ProtocolExtensionField_176P0__extensionValue, present),
	sizeof(((struct ProtocolExtensionField_176P0__extensionValue *)0)->present),
	0,	/* No top level tags */
