...
int
E_RAB_IE_ContainerList_261P0_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static asn_oer_constraints_t asn_OER_type_E_RAB_IE_ContainerList_261P0_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..256)) */};
asn_per_constraints_t asn_PER_type_E_RAB_IE_ContainerList_261P0_constr_1 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_E_RAB_IE_ContainerList_261P0 = {
	...
	sizeof(asn_DEF_E_RAB_IE_ContainerList_261P0_tags_1)
		/sizeof(asn_DEF_E_RAB_IE_ContainerList_261P0_tags_1[0]), /* 1 */
	{ &asn_OER_type_E_RAB_IE_ContainerList_261P0_constr_1, &asn_PER_type_E_RAB_IE_ContainerList_261P0_constr_1, E_RAB_IE_ContainerList_261P0_constraint },
