...
static const asn_ioc_cell_t asn_IOS_Bearers_SubjectToStatusTransfer_ItemIEs_1_rows[] = {
	
};
static const asn_ioc_set_t asn_IOS_Bearers_SubjectToStatusTransfer_ItemIEs_1[] = {
	0, 0, asn_IOS_Bearers_SubjectToStatusTransfer_ItemIEs_1_rows
};
static int
...
static asn_CHOICE_specifics_t asn_SPC_value_specs_4 = {
	sizeof(struct ProtocolIE_Field_128P0__value),
	offsetof(struct ProtocolIE_Field_128P0__value, _asn_ctx),
	offsetof(struct ProtocolIE_Field_128P0__value, present),
	sizeof(((struct ProtocolIE_Field_128P0__value *)0)->present),
	0,	/* No top level tags */
