...
static asn_CHOICE_specifics_t asn_SPC_value_specs_4 = {
	sizeof(struct PrivateIE_Field_192P0__value),
	offsetof(struct PrivateIE_Field_192P0__value, _asn_ctx),
	offsetof(struct PrivateIE_Field_192P0__value, present),
	sizeof(((struct PrivateIE_Field_192P0__value *)0)->present),
	0,	/* No top level tags */
